...
def update_item_score(*, session: Session, item_id: uuid.UUID) -> None:
    ...
    NOTE: This function no longer updates related items to prevent infinite recursion.
    If you need to update scores for multiple items, call this function for each item explicitly.
    """
